...
const VideoLayoutThree = ({ video }) => {
  ...
  return (
    <Link href={`/videos/${video.id}`} className="group flex flex-col items-center border-[2px] cursor-pointer hover:border-primary transition-all ease-in-out hover:shadow-sm rounded-lg p-3 lg:min-h-[300px]">
