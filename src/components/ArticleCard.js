...
const ArticleCard = () => {
  return (
    <div className="overflow-hidden rounded-lg w-[88%] md:w-[97%] md:mt-20 md:mb-20 mt-10 mb-10 m-auto bg-neutral-100 flex justify-between items-center flex-col lg:flex-row">
