...
const ArticleCard = () => {
  return (
    <div className="overflow-hidden rounded-lg w-[88%] lg:w-[75%]  md:w-[97%] md:mb-20  my-10  m-auto bg-neutral-100 flex justify-between items-center flex-col lg:flex-row">
