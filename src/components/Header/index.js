  ...
  return (
    <header id='header'>
      <div id='headerr' dir='' style={{ backgroundColor: "#f7f7f7" }} className="w-full  shadow-lg md:h-24 py-2 md:py-0 md:px-10 flex items-center justify-between fixed lg:top-0 top-0 left-0 right-0 z-50">
        ...
        <button className='tajawal-light mt-1 md:mt-0 flex items-center gap-1 md:gap-2   md:text-gray-500'>  <span className='text-black hidden md:block'>English </span><span className='text-black   rounded-full md:hidden text-sm'>EN </span> <Globe className='hidden md:block' size={18}/>  <span className='md:text-xl'> | </span> </button>
          <Logo />
