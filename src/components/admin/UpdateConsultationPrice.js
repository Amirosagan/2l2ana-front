...
const UpdateConsultationPrice = ({ doctorId }) => {
  ...
  useEffect(() => {
    const fetchDoctorData = async () => {
      try {
        ...
        const response = await fetch(`https://mettamena.runasp.net/api/Doctor/${doctorId}`, {
          method: "GET",
          headers: {
  ...
  const updateConsultationPrice = async () => {
    try {
      ...
      const response = await fetch(`https://mettamena.runasp.net/api/Doctor/UpdateDoctorConsultationPrice`, {
        method: "POST",
        headers: {
